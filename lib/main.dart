...
import 'widget/excersieDetailPage.dart';
    ...
    return MaterialApp(
        ...
        theme: ThemeData(
          ...
          inputDecorationTheme: const InputDecorationTheme(
              ...
              labelStyle: TextStyle(color: Color(0xff322751)),
        ...
        routes: {
          ...
          ExcersiseListPage.routName: (context) => const ExcersiseListPage(),
          ExcerciseDetailPge.routName: (context) => const ExcerciseDetailPge(),
          FilterPage.routeName: (context) => const FilterPage(),
          BmiPage.routeName: (context) => const BmiPage()
        },
        home: const HomePage()
